    ...
    <>
      <div className="h-fit rounded-t-full border border-solid border-gray-100 p-2 mb-2">
        ...
        <div className="flex flex-col justify-center items-center mb-4">
          ...
          <div>
            <span className="text-stone-900 text-lg font-medium font-['Jost']">
              Takes less than
            </span>{" "}
            <span className=" text-red-600 text-xl font-medium font-['Jost']">
              5 minutes...
            </span>{" "}
          </div>
        </div>
        <div className="mx-10">
         ...
         <div className="text-yellow-500 text-sm font-normal font-['Jost'] ">
              klincik7@gmail.com
            </div>
            <span className="text-gray-400 text-xs font-normal font-['Jost'] leading-tight">
              This email address already exists.
            </span>
            <span className="text-gray-400 text-xs font-normal font-['Jost'] underline leading-tight">
              Sign in
            </span>
         </div>
          <div className="mb-4">
      ...
      <div className="flex flex-col mb-2 justify-center items-center ">
        <div>
          <input type="checkbox" className="mr-2 mx-2" />
          <label className="text-stone-900 text-sm font-medium font-['Jost'] leading-tight">
            I’m an Expert
          </label>
        </div>
        <div>
      ...
      <div className="text-center ">
        ...
        <span className="text-gray-400 text-sm font-normal font-['Roboto'] underline leading-normal">
          terms of use
        </span>
        <span className="text-gray-400 text-sm font-normal font-['Roboto'] leading-normal">
          {" "}
